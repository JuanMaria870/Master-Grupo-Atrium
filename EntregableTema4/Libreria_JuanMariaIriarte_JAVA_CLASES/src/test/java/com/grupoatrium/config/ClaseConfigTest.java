...
@ImportResource("classpath:applicationContext-test-db.xml")
public class ClaseConfigTest {
	...
	public DataSource dataSource() {
		...
		EmbeddedDatabase db = builder.setType(EmbeddedDatabaseType.DERBY).ignoreFailedDrops(true)
				.addScript("com/grupoatrium/dbtest/create-db-test.sql").addScript("com/grupoatrium/dbtest/insert-data-test.sql").build();
