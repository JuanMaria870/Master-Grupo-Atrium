...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				new StringBuffer("Datos de actualización: ").append(" Actualización Biografia: ").append(autorUpdate));
		...
		Libro libroCreate2 = new Libro(null, "88888888COT", "Novela", null, 2005, 10.50, "Novela grafia", null);
		...
		editorialUpdate.setLibros(new HashSet<Libro>(libroDao.readAll()));
		...
		libroCreate2 = new Libro(null, "88888888COT", "Novela", null, 2005, 10.50, "Novela grafia", null);
		...
		editorialDelte.setId_editorial(2);
