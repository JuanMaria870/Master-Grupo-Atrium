...
public class AutorExtra implements InitializingBean, DisposableBean {
	...
	public void initMetodo() {
		System.out.println("Init metodo 2.1 (justo despues de inicializar), añadiendo en el contexto"
				+ "default-init-method='init' default-destroy-method='destroyMetodo'"
				+ "o en la creación del mismo bean");
	}

	public void destroyMetodo() {
		System.out.println("Previo a detruir metodo 2.1 (justo despues de inicializar), añadiendo en el contexto"
				+ "default-init-method='init' default-destroy-method='destroyMetodo'"
				+ "o en la creación del mismo bean");
	}

	public void initMetodo2() {
		System.out.println("Init metodo 2.2 (justo despues de inicializar), añadiendo en el contexto"
				+ "default-init-method='init' default-destroy-method='destroyMetodo'"
				+ "o en la creación del mismo bean");
	}

	public void destroyMetodo2() {
		System.out.println("Previo a detruir metodo 2.2 (justo despues de inicializar), añadiendo en el contexto"
				+ "default-init-method='init' default-destroy-method='destroyMetodo'"
				+ "o en la creación del mismo bean");
	}
